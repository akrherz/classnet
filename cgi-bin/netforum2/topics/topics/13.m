...
===date:Wed Apr 15 14:59:57 1998
===subject:Visible Human Project
===message:http://www.nlm.nih.gov/research/visible/visible_human.html <P><B><P>The National Library of Medicine Visible Human Project</P></B><P>This web site is the home page for the Visible Human Project, an endeavor to completely catalog the internals of the male and female human body.  The site contains both MRI (magnetic resonance imaging) and CT (CAT scan) data, in addition to cryosection images.  The CT data consists of X-ray "slices" of the body taken at 1 mm intervals.  The entire data set of the female is over 40 gigabytes.  Sample images and animations are available for download; in addition, specialized viewers can be downloaded which allow the user to manipulate a 3D image of the body and study a particular internal region at will.  Work is currently being done to link names to the 3D images of the body structures.</P></FONT>
=========yorg=========
===from:Rebecca Longmire
===date:Wed Apr 15 20:29:38 1998
===subject:ENGINES and ORGANS
...
===date:Wed Apr 15 22:22:51 1998
===subject:Going with the flow
===message:Department of Cell Biology at Vanderbilt University of Medicine: The Kidney one Step at a Time <P>http:/www.mc.vanderbilt.edu/~alemanma/kidney-outline.html<P><P>This site provides a basic outline of the kidney including an introduction, the parts that comprise a nephron, the juxtaglomerular apparatus and the excretory portion. Although some biological knowledge may be helpful, the information is explained in a way that is easy to follow and can aid in the basic understanding of structure and function of the kidney. This site also provides a wide variety of graphics to view that including photographs, illustrations and diagrams that help to put the information into context. This is a great site to visit for a review of the basics of why you have to make that trip to the bathroom in the middle of the night or just to view some really great graphics.
=========yorg=========
===from:Matt Sogard
...
=========yorg=========
===from:Wes Haut
===date:Tue Apr 21  1:44:37 1998
===subject:Assignment 5
===message:The John Hopkins University Research and Training Center for Hearing and Balance<P>
http://www.bme.jhu.edu/labs/chb/index.html<P><P>

This site contains multiple pages of information dealing with the vestibular and auditory systems in humans.  Topics include hair cell transmission of sounds, neural encoding of sounds and balance information, vestibular neurophysiology, and case studies, glossaries, and disorders of the vestibulocochlear system.  This site is useful to anyone studying either the auditory or balance systems in any higher animal.  The in-depth information provided gives a comprehensive and easily digested view of how and why these two systems work.  There are also links to related pages, and links to opportunities at John Hopkins and elsewhere.  Overall, this site is a very good place to find relevant, up-to-date information about both the vestibular and auditory systems.  I recommend it to anyone who is interested in either.
=========yorg=========
===from:Lori Applegate
===email:lorapp@iastate.edu
===institution:ISU
===date:Wed Apr 22 14:14:40 1998
===subject:Brief Overview
===message:http://encarta.msn.com/index/concise/0vol13/023c7000.asp<P>
...
===date:Thu Apr 23 10:51:52 1998
===subject:Assignment V
===message:The address I found is:
http://www.medtropolis.com/vbody/
<br>
A Virtual Look at Vital Human Body Parts
<br>
This site had pictures of the human skeletal system, the digestive system, the heart, and the brain.  By moving the mouse around on certain pictures, the name of the part would appear along with a description of it.  You can also view the path of bloodflow in the heart as it pumps.  Oxygenated blood is represented by red dots, and deoxygenated blood is shown as blue dots.  It is possible to zoom in on certain sections of the skeleton, and the brain can be viewed by four different angles.  Many links are available that give information on injuries and other health problems under each category.  This is a general, yet very informative site for structure and function of the human body.
=========yorg=========
===from:Andria Bolton
===email:abolton@iastate.edu
===date:Fri Apr 24 12:57:25 1998
===subject:Assignment 5
===message:http://www.sti.nasa.gov/thesaurus/A/word632.html<P>
<P>
...
===date:Sun Apr 26 16:52:48 1998
===subject:Brain Research
===message:<P><B>http://www.toxi.ethz.ch/bbft/bbft.html</B>

<P><U>An Interdisciplinary Research Group Investigating the Brain’s Inner Workings</U>.

<P>This site starts with their goals stated right from the start. their are links to a graphical representation of what some of the people are focusing on for research. The page tells about many aspects of the research, from facilities to unexpected findings.  The site includes basic descriptions of some models of behavior that the team is developing. The sections describing the given research are limited but to the point and gives a basic understanding about what is trying to be accomplished.  While the site has some nice graphics and appears to be well thought out the lack of any truly substantial information is sad.  It does give a nice introduction to some of the interdisciplinary ideas that the group has formulated. All in all it was a good site in need of a little bit more information is all.
=========yorg=========
===from:Dallas Crowley
===email:kcrowley@nwiowa.com
===institution:Albert City-Truesdale
===date:Sun Apr 26 17:41:23 1998
===subject:Animal Form and Function
===message:http://www.neurophys.wisc.edu/manatee/<P>

The Brain of the Florida Manatee<P>

This site gives information on the brain of the Florida Manatee.  It includes general data, such as the size of the brain, as well as more detailed data.  The site had several pictures of manatees and their brains including coronal brain sections of the entire brain.  It also included links to pages that broke the brain down into each of it's seperate parts (cerebral cortex, thalamus, hypothalamus, etc).  There were also links to sites talking about methods of brain study, evolution of the manatees, and behavior of the manatees as well as brain correlates of manatee lifestyles.  Some of the links are lacking in the extent of it's material because it is still under construction.  Still, it has enourmous potential.  Even the small amount of information it already contains increased my understanding of the manatees and their brains.
=========yorg=========
===from:Dawn Spiller
===date:Sun Apr 26 18:38:20 1998
===subject:Animal form and function
===message:http://www.si.edu/resource/topics/research/resrpts/Spring/whales.htm<p>
Smithsonian Institute research reports:  Scientist work to create portraits of whale and dolphin species<p>
This site is an online reproduction of a report on the work of a curator at the musuem.  This is not an interactive site, but the information given is very interesting.  For those of us who are fascinated with whales and dolphins this article gives a lot of information about the anatomy of these animals and how researchers go about studying them.  Some of the interesting facts are about how they found heat exchangers in the tongue of a whale that serves as a regulator of temperature and keeps the whale from experiencing hypothermia. This site is not all glitz and glam but it does have interesting facts about whales and dolphins.
=========yorg=========
===from:James Nisly
===email:jnisly@kctc.net
===date:Sun Apr 26 21:24:45 1998
...
=========yorg=========
===from:Jeremy Duehr
===date:Mon Apr 27 16:36:24 1998
===subject:Assignment 5
===message:http://aspin.asu.edu/msnews/problist.htm
Multiple Sclerosis can affect many aspects of a persons life by deterioration of bodily functions. This page is meant to help people recognize these problems before they progress.

This article which was written by Catherine W, Brittell M.D. is meant to let people know about the symptoms of Multiple sclerosis and that it can affect many different areas of ones life. Even though the effects are not totally curable they can be slowed by early detection. Dr. Brittell outlines major tests to determine which body functions are being affected and then offers means to treat them. She list not only skeletal muscle control, but also bladder and bowel control as well as sexual problems. Dr. Brittell illustrates that with early detection and proper treatment these problems can be slowed or rehabilitated back to normal. Although the degeneration of the muscle cells is the problem, the power of the mind is often key in healing.
=========yorg=========
...
===subject:Frogs!!!!!!
===message:summit.stanford.edu/creatures/OrganSystemsHut.html
<br>
This site was a 3D interactive site designed for the classroom.  One of the main highlights was was the examination and manipulation of the frog through a virtual dissection.  It showed the organs of the frog, and gave the option of choosing information on a selected organ/system.  The information it gave wasn't extremly technical, rather, it was easy to understand. The site was really easy to use as long as you had the special viewing requirements.  It was really cool and definitely worthwhile.
=========yorg=========
===from:Ellie Nunez
===email:ellie@iastate.edu
===date:Mon Apr 27 21:01:49 1998
===subject:Assignment V
===message:http://www.best.com/~sirlov/cat.shtml
Feline Info Page


	Obviously, this web site is about cats. While it has information about aspects of cats, it covers thier structure and some of the functions too. It mainly does this through explaining the genetics and the expression of these genes. It also discusses how their phenotypes affect their survival- Darwinian fitness- and how one can reasonably predict the feline's appearance based on the genes it carries. While the section on structure and function is somewhat dry, it is labeled so that you can skim the section and find  the information you need quickly. Plus, the other sections of this website include color pictures of several felines, which illustrates some of the examples the essay on genetics used. Overall, the web site is very helpful.
=========yorg=========
===from:Damon Johnson
===date:Mon Apr 27 22:35:41 1998
===subject:Feeling a little lymph?
===message:<p>http://www.alumni.caltech.edu/~mike.lymphoma.html
...
Warning Signs of a Heart Attack;
 ...
 Heart Surgery and Other Treatments;
...
===date:Mon Apr 27 23:57:22 1998
===subject:Unit 5 Assignment
===message:The website I found is:

www.mfmdesign.com/NCI_WEBSITE/PATIENTS/INFO_TEACHER/bookshelf/NIH_immune/index.html
<P>
This website doesn't appear if you type in the site address. The best way to access this site is to type : "immune response national cancer institute" in the search screen in EXCITE and its the first site that comes up.
<P>
This is a wonderful site jointly sponsored by the National Cancer Institute and the National Institute of Allergy and Infectious Diseases entitled "Understanding the Immune System".
<P>
This is a detailed public education site about the immune system. It offers information about a variety of topics about the immune system. Some topics are:
<P>
-self and nonself
<P>
...
<P>
-mounting an immune system response
<P>
-natural and acquired immunity
<P>
-immune system disorders
<P>
Each topic provides a detailed introduction to the topic, including a description of current research findings. The later topics describe frontiers of immunological research. One particularly interesting topic describes the SCID (severe combined immunodeficiency disease) mouse, which is a mouse that has been developed lacking an immune system, and therefore also the ability to reject tissues. This mouse is used as an "in-vivo" laboratory to test the effects of various drugs and tissue transplants.
<P>
Ths site is clear, well laid out and easy to navigate.
<P>
=========yorg=========
